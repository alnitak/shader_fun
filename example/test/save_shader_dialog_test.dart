import 'package:example/studio/dialogs/save_shader_dialog.dart';
import 'package:flutter/material.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:shader_fun/shader_fun.dart';

void main() {
  testWidgets('SaveShaderDialog updates JSON preview when input fields change',
      (tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: SaveShaderDialog(project: project),
        ),
      ),
    );
