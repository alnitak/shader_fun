...
void main() {
  ...
  group('Multi-pass pipeline & BufferChannel resolution', () {
    test(
      'correctly maps Shadertoy buffer IDs and previz paths to bufferIndex',
      () {
        ...
        final project = ShaderProject.fromJson(jsonMap);
        ...
        expect(
          chA0.bufferIndex,
          0,
          reason: 'Buffer A channel 0 should point to Buffer A (0)',
        );
        ...
        expect(
          chB0.bufferIndex,
          0,
          reason: 'Buffer B channel 0 should point to Buffer A (0)',
        );
        ...
        expect(
          chImg0.bufferIndex,
          1,
          reason: 'Image channel 0 should point to Buffer B (1)',
        );
        ...
        expect(
          chImg1.bufferIndex,
          2,
          reason: 'Image channel 1 should point to Buffer C (2)',
        );
      },
    );

    test(
      'compileAllPasses compiles all passes of Mouse Paint Eroded Mountains',
      () async {
        final file = File('example/shaders/mouse_paint_eroded_mountains.json');
        final jsonMap =
            jsonDecode(file.readAsStringSync()) as Map<String, dynamic>;
