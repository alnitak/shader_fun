...
void main() {
  test('Paint streams passes compile and channels are resolved correctly', () async {
    ...
    expect(project.passes.length, 5); // Common, Buffer A, Buffer B, Buffer C, Image
  ...
  test('all json files in example/shaders parse successfully', () {
    ...
    for (final file in files) {
      ...
      expect(project.name.isNotEmpty, isTrue, reason: 'Failed parsing ${file.path}');
    }
  });
}
